...
<section class="roomAvailability">
    ...
    <div class="styled-select">
      <label for="start_month_modal" class="hidden-text"> Month</label>
      {local var="monthSelect_modal"}
    </div>
    <div class="styled-select">
      <label for="start_day_modal" class="hidden-text"> Day </label>
      {local var="daySelect_modal"}
    </div>
    <div class="styled-select">
      <label for="start_year_modal" class="hidden-text"> Year</label>
...
<?php } else { ?>
  <a id="userLoginSubmit" href="{local var="roomReservationHome"}/calendar/user/" class="roomMobile bSubmit">
    ="fa fa-check"></span> My Reservations
  </a>
